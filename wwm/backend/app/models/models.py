...
class Sample(Base):
    ...
    data_source: Mapped[str] = mapped_column(String(20), nullable=False, default="kobo")
    kobo_uuid: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    kobo_id: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    kobo_submission_time: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    what3words: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    what3words_source: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    what3words_status: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    what3words_language: Mapped[Optional[str]] = mapped_column(String(12), nullable=True)
    what3words_map_url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    what3words_nearest_place: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    what3words_country: Mapped[Optional[str]] = mapped_column(String(10), nullable=True)
    what3words_square: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    what3words_updated_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
